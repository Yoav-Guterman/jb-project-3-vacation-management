...
import { createVacation, exportFollowersCSV, getAllVacations, getVacation, removeVacation, updateVacation } from "../controllers/vacations/controller";
...
vacationsRouter.get('/:id', adminValidator, paramsValidation(vacationIdValidator), getVacation)
