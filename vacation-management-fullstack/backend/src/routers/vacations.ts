...
import { newVacationFilesValidator, UpdateVacationValidator, vacationIdValidator, VacationValidator } from "../controllers/vacations/validator";
...
vacationsRouter.patch('/:id', paramsValidation(vacationIdValidator), validation(UpdateVacationValidator), filesValidation(newVacationFilesValidator), fileUploader, updateVacation)
